		...
		<?php
			...
			if(isset($_POST['login']))
			{
				...
				if($_SERVER["REQUEST_METHOD"] == "POST")
				{
					...
					mysqli_select_db($link, "college_prediction_system"); 
					...
					if ($row['Username'] == $username && $row['Password'] == $password) {
						header("location: http://localhost:8080/College-Prediction-System/home.php");
		...
		if(isset($_POST['signup']))
		{
			...
			if($_SERVER["REQUEST_METHOD"] == "POST")
			{
				...
				else if($password1 == $password2)
				{
					...
					header('localhost: http://localhost:8080/College-Prediction-System/login.php');
					echo "Data Stored" ;
				}
				mysqli_close($link);
			}
